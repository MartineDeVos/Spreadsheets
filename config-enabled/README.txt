...
config files, which are located in the directory:
    ...
    /home/mvs246/src/ClioPatria/ClioPatria/config-available

For example, to enhance the system setup   for development, you may wish
to do:

    ==
    ln -s /home/mvs246/src/ClioPatria/ClioPatria/config-available/debug.pl
    ==

This application may  provide   additional  application-specific example
configuration files.

@see	/home/mvs246/src/ClioPatria/ClioPatria/config-available/README.txt
